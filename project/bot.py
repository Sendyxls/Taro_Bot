...
GPT_API_KEY = "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"
...
def get_purchase_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="🔥 PRO (Расширенный расклад) – 99₽  Расклад из 3 карт (Прошлое – Настоящее – Будущее). Связь между картами, совет на основе энергетики расклада. Подходит для быстрого, но атмосферного ответа на вопрос.", callback_data="buy_1")],
        [InlineKeyboardButton(text="💎 MASTER (Глубокий анализ) – 199₽ 5 карт (Прошлое – Настоящее – Будущее – Скрытые факторы – Совет). Глубокий анализ ситуации, раскрытие скрытых аспектов, логичная связь событий. Завершается пророческим напутствием. Для тех, кто хочет больше деталей и понимания.", callback_data="buy_2")],
        [InlineKeyboardButton(text="👑 ULTIMATE (Таро-коучинг) – 399₽ 7 карт (Твой путь – Влияние прошлого – Ситуация сейчас – Скрытые факторы – Препятствия – Потенциал – Итог). Полноценная история судьбы с философским смыслом, архетипами и жизненными циклами. Завершается мощным инсайтом. Для глубокого погружения и трансформационного опыта.", callback_data="buy_3")],
    ])
...
async def process_callback_query(callback_query: types.CallbackQuery):
    ...
    if action == "1":
        description = '🔥 PRO – 99₽'
        prices = [LabeledPrice(label="Расширенный расклад", amount=99 * 100)]
    elif action == "2":
        description = '💎 MASTER – 199₽'
        prices = [LabeledPrice(label="Глубокий анализ", amount=199 * 100)]
    elif action == "3":
        description = '👑 ULTIMATE – 399₽'
        prices = [LabeledPrice(label="Таро-коучинг", amount=399 * 100)]
